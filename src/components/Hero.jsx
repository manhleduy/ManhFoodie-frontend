...
const Hero = () => {
  return (
    <section className='max-padd-container'>
      <div className="lg:bg-[url('/src/assets/bg.png')] bg-cover 
      bg-center bg-no-repeat h-screen w-full rounded-2xl relative">
        <div className='mx-auto max-w-[1440px] px-4 flex flex-col justify-between h-full'>
          <div className='max-w-[780px] pt-44 lg:pt-58'>
            <h3>Fresh bite for Every Mood</h3>
            ...
            <h1 className='font-[800px] leading-none' >
              on Rice & Curries
            </h1>
            ...
            <button className='btn-solid !rounded-none p-5 w-52 text-lg font-bold mt-8'>Shop Now</button>
          </div>
          <div className='pb-9'>
            <Rating />
          </div>
