...
const About = () => {
  return (
    <section className='max-paad-container py-12 xl:py-24'>
              ...
              <div className='flex flex-col items-start gap-y-4'>
                <div className='flexCenter gap-x-4'>
                  <div className='h-16 min-w-16 bg-solid flexCenter rounded-md'>
                    <img src={assets.delivery} alt=""  width={22}
                    className='invert'/>
                  </div>
                  <div>
                    <h4>Secure Online Payments</h4>
                    <p>pay securely using your preferred payment methods
                      with a simple and quick checkout
                    </p>
                  </div>
                </div>
                <div className='flexCenter gap-x-4'>
                  <div className='h-16 min-w-16 bg-solid flexCenter rounded-md'>
                    <img src={assets.secure} alt=""  width={22}
                    className='invert'/>
                  </div>
                  <div>
                    <h4>24/7 Order Support</h4>
                    <p>Our support team is alwaus ready to assist you with any order queries or issues</p>
                  </div>
                </div>
                <div className='flexCenter gap-x-4'>
                  <div className='h-16 min-w-16 bg-solid flexCenter rounded-md'>
                    <img src={assets.phone} alt=""  width={22}
                    className='invert'/>
                  </div>
                  <div>
                    <h4>Fast Food Delivery</h4>
                    <p>Get your favourite meals delivery got and fresh 
                      to your door in just a few minute</p>
                  </div>
                </div>
              </div>
            </div>
